...
ALTER TABLE interprete ADD int_nombre_real VARCHAR(50);

ALTER TABLE interprete ADD INDEX (int_nombre_real);

ALTER TABLE interprete DROP CONSTRAINT int_nombre;

ALTER TABLE cancion MODIFY can_duracion TINYINT;

ALTER TABLE cancion MODIFY can_num_pista TINYINT;

ALTER TABLE disco ADD INDEX (dis_sello, dis_anio);

ALTER TABLE cancion CHANGE can_titulo can_nombre VARCHAR(40) NOT NULL;